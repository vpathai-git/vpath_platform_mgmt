#!/usr/bin/env python3
"""OntoGate gate for vpath-fortune-teller — the app's Spine-3 filling the
app-hull foundation. FOUR-LAYER composition (per foundation/ADOPTION.md +
plan 2026-07-12 Änderung 5):
...
Run:  python3 examples/vpath-fortune-teller/.ontogate/check.py
