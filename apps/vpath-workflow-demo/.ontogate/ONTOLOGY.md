# ONTOLOGY.md — vpath-workflow-demo concept catalog
...
| src.app.api.proxy.[...path].route | frontend | src/app/api/proxy/[...path]/route.ts | [docs/concepts/frontend/src.app.api.proxy.[...path].route.md](../docs/concepts/frontend/src.app.api.proxy.[...path].route.md) |
...
| src.components.workflow-demo | frontend | src/components/workflow-demo.tsx | [docs/concepts/frontend/src.components.workflow-demo.md](../docs/concepts/frontend/src.components.workflow-demo.md) |
...
Dependency edges (R-B checks declared == observed imports): the proxy depends
on delegated auth; the layout and workflow surface depend on providers; the
runtime page depends on the workflow surface.
...
- 2026-07-22 — validated and pinned src.app.api.proxy.[...path].route.
...
- 2026-07-22 — validated and pinned src.components.workflow-demo.
